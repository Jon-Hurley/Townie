<script>
	import { blueStyle, buttonStyle, indigoStyle, redStyle } from '../css';
	import { cancelPremium, initiatePremiumSession } from '../requests/account';
...
{#if simplified}
    ...
    >
        <svg
            ...
            width="26"
            height="26"
            class="text-indigo-500 m-[1px] mt-[2px]"
        >
            <path
